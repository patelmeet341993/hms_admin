...
class MyVisitController {
  Future<void> createDummyVisitDataInFirestore() async {
    VisitModel visitModel = VisitModel(
      ...
      hospitalId: "111",
      hospitalName: "Savita Multispecialist",
      description: "Back Pain",
      createdTime:Timestamp.fromDate(DateTime(2023, 1, 1)),
      updatedTime: Timestamp.now(),
      doctors: {
        AdminUserType.admin : "gjf3Mx4YV1TzAyP7xm0N",
      },
      weight: 70,
      currentDoctorId: "gjf3Mx4YV1TzAyP7xm0N45",
      currentDoctorName: "Meet Patel",
      active: true,
      diagnosis: [
        DiagnosisModel(
          doctorId: "gjf3Mx4YV1TzAyP7xm0N",
          doctorName: "Meet Patel",
          diagnosisDescription: "some joints realaeted things",
          prescription: [
            PrescriptionModel(
